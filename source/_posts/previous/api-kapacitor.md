...
```
如果该模式与任何任务都不匹配，将返回一个空列表，成功码200
...
## 其他
### Ping
可以通过这个接口ping服务, 来验证是否成功连接kapacitor, 返回204代表成功
```http request
...
更多api查看[kapacitor](https://docs.influxdata.com/kapacitor/v1.5/working/api/)官网
